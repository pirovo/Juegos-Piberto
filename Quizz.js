...
function boton_incorrecto1 () {
    ...
    console.log('num_incorrecto: '+num_incorrecto);
    clearInterval(temporizador_level1); //Esto es para que pare la funcion 'iniciarTiempo' si le doy al boton incorrecto.
...
function boton_correcto1 () {
    ...
    console.log('num_correcto: '+num_correcto);
    clearInterval(temporizador_level1); //Esto es para que pare la funcion 'iniciarTiempo' si le doy al boton correcto.
    setTimeout(pasarANivel2, 2000); //Este
}
...
function boton_incorrecto2 () {
    mostrar_resultados2();
    num_incorrecto=num_incorrecto+1;
    console.log('num_incorrecto2: '+num_incorrecto);
...
function boton_correcto2 () {
    mostrar_resultados2();
    num_correcto=num_correcto+1;
    console.log('num_correcto2: '+num_correcto);
    clearInterval(temporizador_level2);
    setTimeout(pasarANivel3, 2000); //Este
}
...
function boton_incorrecto3 () {
    mostrar_resultados3();
    num_incorrecto=num_incorrecto+1;
    console.log('num_incorrecto3: '+num_incorrecto);
...
function boton_correcto3 () {
    mostrar_resultados3();
    num_correcto=num_correcto+1;
    console.log('num_correcto3: '+num_correcto);
    clearInterval(temporizador_level3);
    setTimeout(pasarANivel4, 2000); //Este
}
...
function boton_incorrecto4 () {
    mostrar_resultados4();
    num_incorrecto=num_incorrecto+1;
    console.log('num_incorrecto4: '+num_incorrecto);
...
function boton_correcto4 () {
    mostrar_resultados4();
    num_correcto=num_correcto+1;
    console.log('num_correcto4: '+num_correcto);
    clearInterval(temporizador_level4);
    setTimeout(pasarANivel5, 2000); //Este
}
...
function boton_incorrecto5 () {
    mostrar_resultados5();
    num_incorrecto=num_incorrecto+1;
    console.log('num_incorrecto5: '+num_incorrecto);
...
function boton_correcto5 () {
    mostrar_resultados5();
    num_correcto=num_correcto+1;
    console.log('num_correcto5: '+num_correcto);
    clearInterval(temporizador_level5);
    setTimeout(finish, 2000); //Este
    resultados();
}
