...
//Level 1
//Pasar de Level1 a Level2 (respuesta incorrecto)
...
//Pasar de Level1 a Level2 (respuesta correcto)
...
function pasarANivel2() {
    level1.style.display = "none"; //'style' permite cambiar el css del elemento id al que nos referimos
...
//Level 2
//Pasar de Level2 a Level3 (respuesta incorrecta)
...
//Pasar de Level2 a Level3 (respuesta correcta)
...
//Level 3
//Pasar de Level3 a Level4 (respuesta incorrecta)
...
//Pasar de Level3 a Level4 (respuesta correcta)
function boton_correcto3 () {
    mostrar_resultados3();
    num_correcto=num_correcto+1;
    clearInterval(temporizador_level3);
    setTimeout(pasarANivel4, 2000); 
}
...
//Level 4
//Pasar de Level4 a Level5 (respuesta incorrecta)
...
//Pasar de Level4 a Level5 (respuesta correcta)
...
//Level 5
//Pasar de Level5 a Finish (respuesta incorrecta)
...
//Pasar de Level5 a Finish (respuesta correcta)
